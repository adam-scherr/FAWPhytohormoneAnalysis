...
### Version 7, making averages and standard error graphs for just control diet
...
#####Averages and Standard Errors for control diet data####
...
df <- data.frame(microbe_treatment, diet_treatment, spiked_avg, spiked_sterr)
  #this "df" dataframe is the info needed for the data table
